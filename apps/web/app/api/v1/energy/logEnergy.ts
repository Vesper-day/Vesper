// Energy logging core logic (§9), extracted from route.ts.
//
// Next.js App Router route files may export ONLY HTTP-method handlers + segment
// config; a pure helper like logEnergy is an invalid Route export, so it lives
...
import type { EnergyLogRequest, EnergyLogResponse } from '../profile/schemas';
