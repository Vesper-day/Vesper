        ...
        return (
          <button
            ...
            className={cn(
              ...
              'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-bronze focus-visible:shadow-glow',
              // Rich posture (ADD-D): the active segment lifts with the bronze glow.
              selected ? 'bg-bronze text-espresso shadow-glow' : 'bg-transparent text-cream-muted hover:text-cream',
            )}
          >
            {o.label}
          </button>
