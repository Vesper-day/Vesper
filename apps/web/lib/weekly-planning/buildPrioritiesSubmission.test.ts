...
//
// Unit tests for the web priority-submission builder (Chat 057). Pure — NO DOM, NO
// @testing-library, NO network. Asserts the 3–5 length invariant, the { text, source }
// PUT item shape (no completedAt leaks), and the ai_suggested → user source flip on
// edit.
