...
**Screen 8 — Module Selection.** Headline: "Which of these matters to you?" Work and Tasks and Calendar are active by default and not shown as toggles here. The user selects one lifestyle module to begin with (Fitness, Nutrition, Sleep, Errands, Medication, or Finance). The product proposes additional modules over the following weeks, one at a time, as the user's rhythm stabilizes. Copy: "Which part of your life should I start with? We can add more whenever you're ready."
...
| First plan reveal, prompted adjustment (P11) | "Your first day is ready. Anything I should move?" |
| Morning knock push (P6) | "Your day is ready." |
| Morning knock permission ask (P6) | "I can knock once each morning when your day is ready. Nothing else. May I?" |
| Vesper hour open (P2, P5) | "Here's what I handled today." |
| Butler's notebook entry (P9) | "I've noticed you move workouts to the evening. I'll plan them there, unless you'd rather I didn't." |
| Trial-end ledger lead-in (P10) | "This week I arranged [N] blocks, resolved [N] conflicts, planned [N] meals, and reshuffled your day [N] times." |
